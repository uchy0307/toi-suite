...
const QUESTIONS = [
  {
    id: "q1",
    title: "現状把握",
    q: "今、寄付・貢献の満足度について、どんな状況ですか？感じている課題や違和感を具体的に教えてください。",
    placeholder: "例：寄付・貢献の満足度についてうまくいかないと感じている..."
  },
  {
    id: "q2",
    title: "過去の経験",
    q: "寄付・貢献の満足度に関連する過去の経験で、印象に残っているものは何ですか？うまくいった/失敗した、両方教えてください。",
    placeholder: "例：以前〇〇したとき、〇〇の結果になった..."
  },
  {
    id: "q3",
    title: "理想の状態",
    q: "寄付・貢献の満足度について、理想の状態はどんな姿ですか？1年後、または5年後、どうなっていたいですか？",
  ...
  },
  {
    id: "q5",
    title: "最初の一歩",
    q: "寄付・貢献の満足度について、今週、明日、または今すぐできる「最初の小さな一歩」は何だと思いますか？",
