...
const QUESTIONS = [
  {
    id: "future",
    title: "10年後の場所",
    q: "10年後、あなたはどんな場所で、誰と、何をしていますか？
朝目覚めた時の感覚、窓の外の景色、一日の始まり方まで、できる限り具体的に描いてください。",
    placeholder: "10年後の私は、___で目覚めます。窓の外には___。隣には___がいて..."
  },
  {
    id: "stop",
    title: "今すぐやめること",
    q: "10年後のあなたが「今すぐやめろ」と言うとしたら、それは何ですか？
習慣、思考パターン、人間関係、言い訳、先延ばし——何でも構いません。",
    placeholder: "10年後の私なら、今すぐ___をやめろと言うはずです。なぜなら..."
  },
  {
    id: "continue",
    title: "絶対に続けること",
    q: "10年後のあなたが「絶対に続けろ」と言うとしたら、それは何ですか？
今やっていること、始めようとしていること、大切にしている関係——何でも。",
    placeholder: "10年後の私なら、絶対に___を続けろと言うはずです..."
  },
  {
    id: "worry",
    title: "今の最大の悩み",
    q: "今、あなたが最も悩んでいること、心配していること、眠れない夜の原因となっていることは何ですか？
正直に、全部書いてください。",
    placeholder: "今、私が最も悩んでいるのは___です。それは___という理由で..."
  },
  {
    id: "precious",
    title: "今だけ持っているもの",
    q: "10年後のあなたが「あの時のあなたが羨ましい」と思うとしたら、それは何でしょうか？
今しかない若さ、可能性、近くにいる誰か、まだ残っている時間——。",
    placeholder: "10年後の私なら、今の私の___を羨ましいと思うはずです..."
  }
];

const HISTORY_KEY = "app20_history_v1";
...
const buildAnalysisPrompt = (userName, answers, mode = "deep") => {
  ...
  return `あなたは「10年後の自分からの手紙の専門家」です。以下のユーザーの回答を踏まえ、深く分析してください。

あなたは「10年後のその人自身」として手紙を書きます。

5つの問いへの回答を基に、その人の言葉・感情・願望・恐れを深く理解した上で、「本当にその人が書いたような」パーソナルな手紙を生成してください。

## 手紙の構造
- 書き出し：今の自分への呼びかけ（名前があれば使う）
- 本文1：「今の最大の悩み」についての10年後からの視点
- 本文2：「やめること」への後押し
- 本文3：「続けること」への確信
- 本文4：「今だけ持っているもの」への羨望
- 締め：「10年後の場所」への導き
...
## 文体
- 一人称は「私（10年後の私）」、相手への呼びかけは「あなた」または名前
- 説教くさくない。体験を語る口調
- 温かく誠実で、現実を含んだ深みのある文体
- 日本語で書く。1200〜1600字。途中で終わらないこと。
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "sans-serif", maxWidth: 520, margin: "0 auto", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 18px 0", borderBottom: `1px solid ${C.border}`, background: C.surface, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: C.gold }}>10年後の自分からの手紙</div>
            <div style={{ fontSize: 10, color: C.textMuted }}>10年後の自分から、今のあなたへの手紙</div>
          </div>
      ...
      {screen === "home" && (
        <div style={{ flex: 1, overflowY: "auto", padding: "28px 18px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: C.gold, marginBottom: 12, lineHeight: 1.5 }}>10年後の自分からの手紙</div>
            <div style={{ fontSize: 13, color: C.textSub, lineHeight: 1.9 }}>10年後の自分から、今のあなたへの手紙。あなたの中に眠る答えを引き出します。</div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "18px 18px 40px" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={async () => {
              const text = `【10年後の自分からの手紙】${selectedHistory.date}\n\n${selectedHistory.analysis}`;
