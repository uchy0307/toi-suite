...
const QUESTIONS = [
  {
    id: "q1",
    title: "モヤモヤの全出し",
    q: "今、頭の中にある「未解決のこと」「気になっていること」「ストレスになっていること」を全部書き出してください。小さなことでも構いません。",
    placeholder: "例：〇〇のことが気になっている、〇〇との関係がモヤモヤする..."
  },
  {
    id: "q2",
    title: "一番重いもの",
    q: "書き出したものの中で、今一番「心の重さ」を感じているのはどれですか？\nなぜそれが重いのか、できる限り正直に書いてください。",
    placeholder: "例：〇〇が一番重い。なぜなら..."
  },
  {
    id: "q3",
    title: "コントロールの分類",
    q: "そのモヤモヤについて、「自分でコントロールできること」と「できないこと」を分けてみてください。",
    placeholder: "コントロールできること：...\nコントロールできないこと：..."
  },
  {
    id: "q4",
    title: "最悪のシナリオ",
    q: "最悪の場合、何が起きますか？\nそしてその確率は何%くらいだと思いますか？",
    placeholder: "最悪の場合：...\n確率：約〇%くらい..."
  },
  {
    id: "q5",
    title: "1年後の視点",
    q: "1年後、このモヤモヤは残っていると思いますか？\nもし残っていないとしたら、何が変わっているでしょうか？",
    placeholder: "例：1年後はおそらく〇〇になっているから..."
  }
];

const HISTORY_KEY = "app04_history_v1";
...
あなたは「メンタル・デトックスの専門家」です。認知行動療法の原則に基づきユーザーのモヤモヤを構造化してください。

### 【モヤモヤの構造マップ】
感情・思考・行動・環境に分類して整理する。

### 【本当の原因の特定】
表面的なモヤモヤの奥にある根本原因を論理的に示す。

### 【今すぐできる一手】
コントロールできることの中から今週中にできる最小の行動を提示する。
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "sans-serif", maxWidth: 520, margin: "0 auto", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 18px 0", borderBottom: `1px solid ${C.border}`, background: C.surface, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: C.gold }}>メンタル・デトックス</div>
            <div style={{ fontSize: 10, color: C.textMuted }}>心のモヤモヤを整理し、感情を解放する</div>
          </div>
      ...
      {screen === "home" && (
        <div style={{ flex: 1, overflowY: "auto", padding: "28px 18px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: C.gold, marginBottom: 12, lineHeight: 1.5 }}>メンタル・デトックス</div>
            <div style={{ fontSize: 13, color: C.textSub, lineHeight: 1.9 }}>心のモヤモヤを整理し、感情を解放する。あなたの中に眠る答えを引き出します。</div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "18px 18px 40px" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={async () => {
              const text = `【メンタル・デトックス】${selectedHistory.date}\n\n${selectedHistory.analysis}`;
