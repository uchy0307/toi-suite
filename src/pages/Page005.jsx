...
const QUESTIONS = [
  {
    id: "q1",
    title: "残したいもの",
    q: "自分がいなくなった後、世界に残したいものは何ですか？\n人・作品・変化・価値観——何でも構いません。",
    placeholder: "例：〇〇という考え方を世の中に広めたい..."
  },
  {
    id: "q2",
    title: "解決したい痛み",
    q: "あなたが最も「解決したい」と感じる、誰かの痛みや問題は何ですか？\n自分の経験からでも、社会課題でも。",
    placeholder: "例：〇〇で苦しんでいる人たちの〇〇を解決したい..."
  },
  {
    id: "q3",
    title: "10歳の自分",
    q: "10歳の自分が聞いたら「かっこいい！」と思う生き方は何ですか？",
    placeholder: "例：〇〇をやっている大人はかっこいいと思う..."
  },
  {
    id: "q4",
    title: "無限のお金があったら",
    q: "お金が無限にあったら、時間をどう使いますか？\n仕事・趣味・人との関わり——できる限り具体的に。",
    placeholder: "例：毎日〇〇をして、〇〇のために〇〇する..."
  },
  {
    id: "q5",
    title: "葬式でのメッセージ",
    q: "自分の葬式で、どんな人に、どんなことを言ってもらいたいですか？",
    placeholder: "例：〇〇さんには「〇〇してくれた人だった」と言ってほしい..."
  }
];

const HISTORY_KEY = "app05_history_v1";
...
const buildAnalysisPrompt = (userName, answers) => {
  ...
  return `あなたは「ライフミッション作成の専門家」です。以下のユーザーの回答を踏まえ、深く分析してください。

あなたは「ライフミッション設計の専門家」です。

### 【あなたのライフミッション（1文）】
「私は〇〇のために〇〇する」という形で力強い1文にまとめる。

### 【ミッションの解説】
なぜその1文がこの人のミッションなのか回答を引用しながら説明する。

### 【ミッションを生きるための3つの選択軸】
日々の意思決定でこのミッションを生きるための具体的な基準を3つ示す。
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "sans-serif", maxWidth: 520, margin: "0 auto", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 18px 0", borderBottom: `1px solid ${C.border}`, background: C.surface, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: C.gold }}>ライフミッション作成</div>
            <div style={{ fontSize: 10, color: C.textMuted }}>人生で本当にやりたいことを言語化する</div>
          </div>
      ...
      {screen === "home" && (
        <div style={{ flex: 1, overflowY: "auto", padding: "28px 18px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: C.gold, marginBottom: 12, lineHeight: 1.5 }}>ライフミッション作成</div>
            <div style={{ fontSize: 13, color: C.textSub, lineHeight: 1.9 }}>人生で本当にやりたいことを言語化する。あなたの中に眠る答えを引き出します。</div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "18px 18px 40px" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={async () => {
              const text = `【ライフミッション作成】${selectedHistory.date}\n\n${selectedHistory.analysis}`;
