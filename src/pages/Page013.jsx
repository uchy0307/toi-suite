...
const QUESTIONS = [
  {
    id: "q1",
    title: "仕事のスキル",
    q: "仕事で身についているスキル・経験・知識を5つ以上書き出してください。",
    placeholder: "例：〇〇の経験、〇〇のスキル、〇〇の知識..."
  },
  {
    id: "q2",
    title: "プライベートのスキル",
    q: "趣味・プライベートで身についているスキル・知識を5つ以上書き出してください。",
    placeholder: "例：〇〇が得意、〇〇について詳しい..."
  },
  {
    id: "q3",
    title: "言われること",
    q: "人から「〇〇と言えばあなた」と言われることはありますか？",
    placeholder: "例：〇〇のことといえば〇〇さん、と言われる..."
  },
  {
    id: "q4",
    title: "独自の組み合わせ",
    q: "自分のスキルの組み合わせで「世界にまだない職業」を作るとしたら、どんな名前になりそうですか？",
    placeholder: "例：〇〇×〇〇の専門家..."
  },
  {
    id: "q5",
    title: "解決できる問題",
    q: "あなたのスキルの掛け合わせで、誰の・どんな問題を解決できそうですか？",
    placeholder: "例：〇〇で悩む〇〇の人たちの問題を解決できそう..."
  }
];

const HISTORY_KEY = "app13_history_v1";
...
const buildAnalysisPrompt = (userName, answers, mode = "deep") => {
  ...
  return `あなたは「才能の掛け算アドバイザーの専門家」です。以下のユーザーの回答を踏まえ、深く分析してください。
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "sans-serif", maxWidth: 520, margin: "0 auto", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 18px 0", borderBottom: `1px solid ${C.border}`, background: C.surface, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: C.gold }}>才能の掛け算アドバイザー</div>
            <div style={{ fontSize: 10, color: C.textMuted }}>複数のスキルを掛け算してユニークなポジションを作る</div>
          </div>
      ...
      {screen === "home" && (
        <div style={{ flex: 1, overflowY: "auto", padding: "28px 18px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: C.gold, marginBottom: 12, lineHeight: 1.5 }}>才能の掛け算アドバイザー</div>
            <div style={{ fontSize: 13, color: C.textSub, lineHeight: 1.9 }}>複数のスキルを掛け算してユニークなポジションを作る。あなたの中に眠る答えを引き出します。</div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "18px 18px 40px" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={async () => {
              const text = `【才能の掛け算アドバイザー】${selectedHistory.date}\n\n${selectedHistory.analysis}`;
