...
const QUESTIONS = [
  {
    id: "q1",
    title: "得意なこと",
    q: "人に「なんでそんなに上手いの？」と言われたことはありますか？\n苦労せずできるのに他の人が苦労していることは何ですか？",
    placeholder: "例：資料をまとめるのが早い、人の話を聴くのが得意..."
  },
  {
    id: "q2",
    title: "子供の頃",
    q: "子供の頃、夢中になっていたことは何ですか？\n時間を忘れて取り組んでいたことを教えてください。",
    placeholder: "例：ブロックで何かを作ること、本を読むこと..."
  },
  {
    id: "q3",
    title: "褒められた経験",
    q: "褒められた時に「そんな当たり前のことで？」と思った経験はありますか？\nどんなことで褒められましたか？",
    placeholder: "例：〇〇さんから〇〇について褒められたが、自分では普通だと思っていた..."
  },
  {
    id: "q4",
    title: "仕事での強み",
    q: "仕事で「これは自分しかできない」「自分が一番うまくやれる」と感じた瞬間はいつですか？",
    placeholder: "例：〇〇の場面で、私だけが〇〇できた..."
  },
  {
    id: "q5",
    title: "市場価値",
    q: "あなたの強みを「仕事・サービス・副業」に変換するとしたら、何ができそうですか？",
    placeholder: "例：〇〇のスキルを活かして〇〇ができそう..."
  }
];

const HISTORY_KEY = "app03_history_v1";
...
const buildAnalysisPrompt = (userName, answers, mode = "deep") => {
  ...
  return `あなたは「強み言語化の専門家」です。以下のユーザーの回答から、無意識の才能を「稼げる言葉」に変換してください。

### 【あなたの3大強み】
各強みに名前を付け、3〜4文で深く説明してください。

### 【強みの市場価値への変換】
各強みがどんな仕事・ニーズに対応できるか、具体例を挙げて示してください。

### 【あなただけのキャッチフレーズ】
強みを一言で表現するフレーズを3パターン提案してください。

### 【今週のアクション】
最初の一歩として今週できることを1つ、具体的に提示してください。
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "sans-serif", maxWidth: 520, margin: "0 auto", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 18px 0", borderBottom: `1px solid ${C.border}`, background: C.surface, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: C.gold }}>強み言語化パートナー</div>
            <div style={{ fontSize: 10, color: C.textMuted }}>無意識の才能を「稼げる言葉」に変換する</div>
          </div>
      ...
      {screen === "home" && (
        <div style={{ flex: 1, overflowY: "auto", padding: "28px 18px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: C.gold, marginBottom: 12, lineHeight: 1.5 }}>強み言語化パートナー</div>
            <div style={{ fontSize: 13, color: C.textSub, lineHeight: 1.9 }}>あなたの中に眠る「稼げる強み」を言語化します。苦労せずできるのに他の人が苦労していることの中に、あなたの本当の価値があります。</div>
          </div>
