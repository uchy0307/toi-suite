...
const QUESTIONS = [
  {
    id: "q1",
    title: "印象に残る経験",
    q: "人生で最も印象に残っている困難・失敗・辛かった経験は何ですか？\n（話せる範囲で構いません）",
    placeholder: "例：〇〇という経験が印象に残っている..."
  },
  {
    id: "q2",
    title: "その時の感情",
    q: "その経験の時、どんな感情を感じていましたか？\nまた、その感情はどこから来ていたと思いますか？",
    placeholder: "例：〇〇という感情を感じていた..."
  },
  {
    id: "q3",
    title: "今の自分への影響",
    q: "その経験は今の自分にどんな影響を与えていると思いますか？\n行動・思考・人間関係——何でも。",
    placeholder: "例：その経験から、今の私は〇〇する傾向がある..."
  },
  {
    id: "q4",
    title: "学んだこと",
    q: "その経験から学んだこと、気づいたことは何ですか？\nそれはあなたの今の強みとどう繋がっていますか？",
    placeholder: "例：あの経験から〇〇を学んだ..."
  },
  {
    id: "q5",
    title: "未来への活用",
    q: "その経験を「財産」として活かすとしたら、何ができそうですか？",
    placeholder: "例：この経験を活かして〇〇できそう..."
  }
];

const HISTORY_KEY = "app12_history_v1";
...
const buildAnalysisPrompt = (userName, answers) => {
  ...
  return `あなたは「過去の経験から学ぶの専門家」です。以下のユーザーの回答を踏まえ、深く分析してください。

あなたは「経験統合の専門家」です。ユーザーの困難な経験を成長の糧に変換してください。

### 【経験の意味の再構築】
その経験がこの人の人生に与えた意味を広い視点から言語化する。

### 【経験が生んだ強み・資質】
その経験があったからこそ身についた能力・視点を具体的に示す。

### 【今の自分への影響の整理】
プラス・マイナス両面を整理しプラスの部分を強調する。

### 【経験を活かす未来の可能性】
この経験をどう社会・他者への貢献に変えられるか提案する。
    ...
    <div style={{ minHeight: "100vh", background: C.bg, color: C.text, fontFamily: "sans-serif", maxWidth: 520, margin: "0 auto", display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "14px 18px 0", borderBottom: `1px solid ${C.border}`, background: C.surface, flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ fontSize: 15, fontWeight: 700, color: C.gold }}>過去の経験から学ぶ</div>
            <div style={{ fontSize: 10, color: C.textMuted }}>辛かった経験を成長の物語に変換する</div>
          </div>
      ...
      {screen === "home" && (
        <div style={{ flex: 1, overflowY: "auto", padding: "28px 18px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: 28 }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 700, color: C.gold, marginBottom: 12, lineHeight: 1.5 }}>過去の経験から学ぶ</div>
            <div style={{ fontSize: 13, color: C.textSub, lineHeight: 1.9 }}>辛かった経験を成長の物語に変換する。あなたの中に眠る答えを引き出します。</div>
          </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "18px 18px 40px" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={async () => {
              const text = `【過去の経験から学ぶ】${selectedHistory.date}\n\n${selectedHistory.analysis}`;
